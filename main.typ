...
*История:* архитектуру трансформеров разработала компания *Google* в 2017 году (статья #link("https://arxiv.org/abs/1706.03762")["Attention Is All You Need"]). Это стало настоящей революцией в обработке естественного языка.
